  ...
  const foundations = [
    {
      ...
      number: "01",
      content: "Sự phát triển của lực lượng sản xuất và quan hệ sản xuất mới xã hội chủ nghĩa. Chế độ sở hữu xã hội chủ nghĩa đối với tư liệu sản xuất thay thế chế độ tư hữu, tạo cơ sở cho việc xây dựng quan hệ bình đẳng trong gia đình.",
    ...
    },
    {
      ...
      number: "02",
      content: "Việc thiết lập chính quyền nhà nước của giai cấp công nhân và nhân dân lao động. Nhà nước xã hội chủ nghĩa là công cụ xóa bỏ những luật lệ cũ kỹ, lạc hậu và thực hiện việc giải phóng phụ nữ.",
    ...
    },
    {
      ...
      title: "Cơ sở Văn hóa",
      number: "03",
      content: "Những giá trị văn hóa được xây dựng trên nền tảng hệ tư tưởng chính trị của giai cấp công nhân. Sự phát triển hệ thống giáo dục, khoa học và công nghệ góp phần nâng cao trình độ dân trí.",
