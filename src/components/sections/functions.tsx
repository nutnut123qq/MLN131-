  ...
  const functions = [
    {
      ...
      color: "bg-rose-500",
      description: "Chức năng đặc thù của gia đình, không một cộng đồng nào có thể thay thế. Đáp ứng nhu cầu tâm sinh lý tự nhiên của con người, duy trì nòi giống và đáp ứng nhu cầu về sức lao động của xã hội.",
      details: [
